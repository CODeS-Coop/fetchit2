...
define("F2_D7_CTYPE_BODY","body");
define("F2_D7_CTYPE_BODY_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_BODY);
define("F2_D7_CTYPE_BODY_FLD",F2_D7_CTYPE_BODY.F2_D7_FIELD_VAL_SUFFIX);
...
define("F2_D7_CTYPE_DBPORT_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_DBPORT);
define("F2_D7_CTYPE_DBPORT_FLD",F2_D7_CTYPE_DBPORT.F2_D7_FIELD_VAL_SUFFIX);
define("F2_D7_CTYPE_DBNAME","field_fetch_it_db_name");
define("F2_D7_CTYPE_DBNAME_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_DBNAME);
define("F2_D7_CTYPE_DBNAME_FLD",F2_D7_CTYPE_DBNAME.F2_D7_FIELD_VAL_SUFFIX);
define("F2_D7_CTYPE_DBUSER","field_fetch_it_db_login");
define("F2_D7_CTYPE_DBUSER_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_DBUSER);
define("F2_D7_CTYPE_DBUSER_FLD",F2_D7_CTYPE_DBUSER.F2_D7_FIELD_VAL_SUFFIX);
...
define("F2_D7_CTYPE_RECSEL_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_RECSEL);
define("F2_D7_CTYPE_RECSEL_FLD",F2_D7_CTYPE_RECSEL.F2_D7_FIELD_VAL_SUFFIX);
define("F2_D7_CTYPE_UIDFLD","field_fetchit2_user_uid_field");
define("F2_D7_CTYPE_UIDFLD_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_UIDFLD);
define("F2_D7_CTYPE_UIDFLD_FLD",F2_D7_CTYPE_UIDFLD.F2_D7_FIELD_VAL_SUFFIX);
define("F2_D7_CTYPE_KEYFLD","field_fetchit2_key_field");
define("F2_D7_CTYPE_KEYFLD_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_KEYFLD);
define("F2_D7_CTYPE_KEYFLD_FLD",F2_D7_CTYPE_KEYFLD.F2_D7_FIELD_VAL_SUFFIX);
define("F2_D7_CTYPE_RECTBL","field_fetchit2_record_select_tbl");
define("F2_D7_CTYPE_RECTBL_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_RECTBL);
define("F2_D7_CTYPE_RECTBL_FLD",F2_D7_CTYPE_RECTBL.F2_D7_FIELD_VAL_SUFFIX);
define("F2_D7_CTYPE_SUBLBL","field_fetchit2_submit_label");
define("F2_D7_CTYPE_SUBLBL_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_SUBLBL);
define("F2_D7_CTYPE_SUBLBL_FLD",F2_D7_CTYPE_SUBLBL.F2_D7_FIELD_VAL_SUFFIX);
...
define("F2_D7_CTYPE_REDIR_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_REDIR);
define("F2_D7_CTYPE_REDIR_FLD",F2_D7_CTYPE_REDIR.F2_D7_FIELD_VAL_SUFFIX);
define("F2_D7_CTYPE_VALID","field_fetchit2_validate");
define("F2_D7_CTYPE_VALID_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_VALID);
define("F2_D7_CTYPE_VALID_FLD",F2_D7_CTYPE_VALID.F2_D7_FIELD_VAL_SUFFIX);
define("F2_D7_CTYPE_SUBMIT","field_fetchit2_submit");
define("F2_D7_CTYPE_SUBMIT_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_SUBMIT);
define("F2_D7_CTYPE_SUBMIT_FLD",F2_D7_CTYPE_SUBMIT.F2_D7_FIELD_VAL_SUFFIX);
define("F2_D7_CTYPE_CTITLE","field_fetchit2_content_title");
define("F2_D7_CTYPE_CTITLE_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_CTITLE);
define("F2_D7_CTYPE_CTITLE_FLD",F2_D7_CTYPE_CTITLE.F2_D7_FIELD_VAL_SUFFIX);
define("F2_D7_CTYPE_CDESC","field_fetchit2_content_desc");
define("F2_D7_CTYPE_CDESC_TBL",F2_D7_FIELD_TBL_PREFIX.F2_D7_CTYPE_CDESC);
define("F2_D7_CTYPE_CDESC_FLD",F2_D7_CTYPE_CDESC.F2_D7_FIELD_VAL_SUFFIX);
